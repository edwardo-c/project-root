...
def test_file_details(ftype: str) -> dict:
    ...
    '''
    d = {
        'direct' : {'file_path': r"C:\Users\eddiec11us\Documents\vs code workspaces\project_root\pos_xref\data\raw\direct_customers_export.xlsx",
                    'sheet_name': 'Data',
                    'header_row': 0,
                    'columns': ['Customer ID', 'Customer Name', 'State', 'Postal Code', 'Account Group']},
        'pos_sales': {'file_path': r"C:\Users\eddiec11us\Documents\vs code workspaces\project_root\pos_xref\data\raw\Incentive Comp - 2025.xlsx", 
                    'sheet_name': 'POS',
                    'header_row': 5,
                    'columns':['SoldToName', 'BillToCustomerZip', 'BillToCustomerState']}, 
        'matches' : {'file_path': r"C:\Users\eddiec11us\Documents\vs code workspaces\project_root\pos_xref\data\output\matches.csv"},
        'processed' : {'file_path': r"C:\Users\eddiec11us\Documents\vs code workspaces\project_root\pos_xref\data\processed\processed_matches.csv"}
    }
    return d[ftype]

def prod_file_details(ftype: str) -> dict:
    '''
    return all pertinent info for the files in the prod system
    sheet_name and header row not required for csv file types
    '''
    d = {
        'direct' : {'file_path': r"H:\Sales Operations\POS XREF\direct_customers_export.xlsx",
                    'sheet_name': 'Data',
                    'header_row': 0,
                    'columns': ['Customer ID', 'Customer Name', 'State', 'Postal Code', 'Account Group']},
        'pos_sales': {'file_path': r"H:\Sales Operations\Accounting - BTG Share\Incentive Comp - 2025.xlsx", 
                    'sheet_name': 'POS',
                    'header_row': 5,
                    'columns':['SoldToName', 'BillToCustomerZip', 'BillToCustomerState']}, 
        'matches' : {'file_path': r"H:\Sales Operations\POS XREF\approved_matches.csv"},
        'processed' : {'file_path': r"H:\Sales Operations\POS XREF\processed_matches.csv"}
    }
